...
public class CargarDatosUsuario implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Usuario usuario = new Usuario("Baspi", "Baspi", "baspi@gmail.com", passCifrada, UsuarioRole.ROLE_USER);
        userRepository.save(usuario);

        Usuario usuarioAdmin = new Usuario("Flor", "Lecha", "florlecha@gmail.com", passCifradaAdmin, UsuarioRole.ROLE_ADMIN);
